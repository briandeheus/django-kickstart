...
SECRET_KEY = "django-insecure-^t+c@_loi^y1z4iq4gm%=ibjv@%3w*jvimfheh(o+)xc=lt=y6"
...
if trusted_origins := os.environ.get("CSRF_TRUSTED_ORIGINS"):
...
# an API key that looks like this: core-abc....xyz
API_KEY_PREFIX = "core"
